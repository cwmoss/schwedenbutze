...
| **REQ-02** | [02-ical-google-calendar-sync.md](./02-ical-google-calendar-sync.md) | 📝 Spezifiziert | Automatische Synchronisation mit Google Kalender & iCal Feeds der Vermieter ([Tasks](./02-tasks-ical-sync.md)) |
